...
class WebviewProvider {
    constructor(extensionUri) {
        ...
        this.fileOps = new fileOperations_1.FileOperations();
        this.terminal = new terminalManager_1.TerminalManager();
        this.git = new gitOperations_1.GitOperations(this.terminal);
        this.webSearch = new webSearch_1.WebSearch();
    ...
    async handleToolCall(toolName, params) {
        ...
        try {
            ...
            const autoExecute = config.get('autoExecuteCommands');
    ...
    async requestConfirmation(toolName, params) {
        ...
        const result = await vscode.window.showWarningMessage(message, { modal: true }, 'Allow', 'Deny');
        return result === 'Allow';
    }
    ...
    sendToolOutput(toolName, output) {
